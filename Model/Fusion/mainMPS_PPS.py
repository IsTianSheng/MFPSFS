...
def main(r, mode, k, train_url, target_url):
    ...
    train_url = train_url + '_k' + str(k) + '_' + str(r) + '.base'
    target_url = target_url+ mode + '_k' + str(k) + '_' + str(r) + '1.txt'
    ...
    if mode == "explicit":
        ...
        trainVector1, trainMaskVector1, batchCount = data.to_Vectors(trainSet1, userCount, \
                                                                   itemCount, userList_test1, "userBased")
...
if __name__ == '__main__':
    ...
    # K = [10, 12, 14, 16, 18, 20]
    train_url = '../../Data/' + dataset + '/PS_N/N/50'
    target_url = '../../result_new/' + dataset + '/PPS_N/50_'
    ...
    for r in [1, 2,3,4,5]:
        for k in K:
            ...
            mode = params.modes[0]
            p.apply_async(main, (r, mode, k, train_url, target_url))
    p.close()
    p.join()
    ...
    # for r in [1,2,3]:
    #     for i in [10, 20, 30]:
    #         train_url = '../../Data/' + dataset + '/PS_N/N/'+str(i)
    #         target_url = '../../result_new/' + dataset + '/PPS_N/'+str(i)+'_'
    #         p = Pool(processes=3)
    #         for k in K:
    #             mode = params.modes[0]
    #             p.apply_async(main, (r, mode, k, train_url, target_url))
    ...
    # # Neighbors
    # train_url = '../../Data/' + dataset + '/PS_N/N/50_k50.base'
    # target_url = '../../result_new/' + dataset + '/PPS_N/50_explicit_k501.txt'
    # mode = params.modes[0]
    # main(mode, 50, train_url, target_url)
