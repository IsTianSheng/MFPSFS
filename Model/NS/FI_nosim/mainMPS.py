...
def main(mode, k, train_url, target_url):
    ...
    # test_url = "../../Data/Ciao/initial/Ciao.test"
    train_url = train_url + '_mPS_k' + str(k) + '.base'
    target_url = target_url+ mode + '_k' + str(k) + '11111111111.txt'
...
if __name__ == '__main__':
    ...
    # PS_method = params.methods['FPS'][sign]

    # FPS_mm = params.methods['FPS'][3]
    # train_url = '../../../Data/' + dataset + '/final/intermediate/' + NS_method + '/' + FPS_mm
    # target_url = '../../../result_fusion/' + dataset + '/MPS/' + NS_method + '/' + FPS_mm + '/'
    # p = Pool(processes=3)
    # for k in K:
    ...
    # mode = params.modes[0]
    # main(mode, 300, train_url, target_url)

    for sign in [0]:
        FPS_mm = params.methods['FPS'][sign]
        train_url = '../../../Data/' + dataset + '/final/intermediate/' + NS_method + '/PS_NS_' + FPS_mm
        target_url = '../../../result_fusion/' + dataset + '/MPS/' + FPS_mm + '/PS_NS_'
